...
const HomePage = () => {
  ...
  <div className="swiper-slide" style={{width:"200px"}} key={product.id}>
    <div className="product-card position-relative" >
      <div className="image-holder">
        <img style={{height:"200px"}} src={product.image} alt={product.title} className="img-fluid" />
      </div>
      ...
      <div className="card-detail d-flex justify-content-between align-items-baseline pt-3">
        <h3 className="card-title text-uppercase">
          <a href="#">{truncateTitle(product.title, 5)}</a>
        </h3>
